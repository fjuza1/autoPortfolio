...
class ProjectsView extends View {
  ...
  #contentProjectModal(_data) {
    const columnCard ='<div class="col-sm-8">'
      const card = this._data.map(demo => `
        <img class="card-img-top" src="${demo.imgPath}" alt="Card image cap">
        <div class="card-body">
          <p class="card-text"><u>${demo.url}</u></p>
        </div>`)
      return [columnCard, `<div class="card">`, card, this._end, this._end].flat()
  }
}
