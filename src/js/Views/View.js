...
export default class View {
    ...
    _removeError(data) {
        ...
        errorField.classList.remove(escapeCSS('outlineField'))
    }
    /**
...
_setOffcanvasDisplay(e) {
  ...
  `;
    ...
    _renderErrorList(errors) {
        ...
        const lis = [];
        errors.forEach(err => {
            document.getElementById(err.id).classList.add(escapeCSS('outlineField'))
    ...
    _disableBTN(options) {
        ...
        if (!disabled) {
            if (existingButton) {
                this._selectedBTN.classList.add(escapeCSS('disabled'))
            } else if (specificButton) {
                specificButton.classList.add(escapeCSS('disabled'))
            }
        } else {
            if (existingButton) this._selectedBTN.classList.remove(escapeCSS('disabled'))
            else specificButton.classList.remove(escapeCSS('disabled'))
        }
    }
    //end
