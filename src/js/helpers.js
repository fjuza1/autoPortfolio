...
export const saveToLocalStorage = (name, data) => localStorage.setItem(name, JSON.stringify(data));
export const readFromLocalStorage = name => JSON.parse(localStorage.getItem(name));
